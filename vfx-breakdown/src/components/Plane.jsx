...
export default function Plane({ location = [0, 0, 0], imgSrc, cosScroll }) {
  ...
  useMemo(() => {
    ...
    const parallaxFactor = -5; // Use Z position as a factor for parallax intensity
    texture.offset.x = -parallaxFactor * cosScroll * 0.5 * pan_effect; // Adjust for desired effect
